  ...
  <ion-page>
    ...
    <ion-content :fullscreen="true" class="ion-padding">
      ...
      <ion-text color = "primary" >เกี่ยวกับเรา</ion-text>
        ...
        <ion-col>
        <ion-button @click="presentAlert" shape="block">Show Alert</ion-button>
        </ion-col>

        <ion-col>
         <ion-button @click="presentAlertConfirm" color="success" shape="block">Show Confirm</ion-button>
        </ion-col>
        </ion-row>

        <ion-row>
        <ion-col class="center_item">
        <ion-button @click="inputAlert" color="danger" shape="round">Show Alert (checkbox)</ion-button>
        </ion-col>
        </ion-row>
